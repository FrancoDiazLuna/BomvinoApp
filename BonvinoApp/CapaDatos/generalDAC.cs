...
namespace BonvinoApp.CapaDatos
{
    class generalDAC
    {
        ...
        public static Vino vino11 = new Vino("ImagenEtiqueta2", 2023, "Mandamas", "Vista: Rojo rubí profundo.\r\nNariz: Aromas de frutas rojas maduras, ciruelas y moras, con sutiles notas de especias y vainilla.\r\nBoca: En boca es jugoso y bien balanceado, con taninos suaves y redondos. Sabores de frutos rojos, chocolate y un leve toque de roble. Final agradable y persistente.", 5f, crearListaVarietales(), crearListaReseña6(), bodega7);
